export default function Hero() {
  return (
    <section className="relative min-h-screen bg-[#0D0D0D] flex flex-col justify-center px-6 py-24 lg:px-20 lg:py-40">
      ...
      {/* Headline */}
      <h1
        className="font-[family-name:var(--font-cormorant)] font-semibold tracking-tight text-[#F5F0EB] text-6xl leading-none lg:text-[88px] lg:max-w-4xl"
      >
      ...
      <div className="absolute bottom-0 left-0 right-0 h-px bg-[#C9A96E]/30" />
    </section>
  );
}
